...
//            {INF, 1, INF},};
        ...
        int[][] parentTEST = new int[test.length][test.length];
        ...
        for (int i = 0; i < test.length; i++) {
            ...
            for (int j = 0; j < parentTEST.length; j++) {
                if (parentTEST[i][j] != 1000) {
                    System.out.println(labelsTST[parentTEST[i][j]]);
